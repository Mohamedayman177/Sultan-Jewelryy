...
<div id="customerModal" class="customer-modal" aria-hidden="true" data-store-url="<?php echo e(route('customers.store')); ?>">
    ...
    <div class="customer-modal__dialog" role="dialog" aria-modal="true" aria-labelledby="customerModalTitle">
        ...
        <div id="customerStepPick" class="customer-modal__step-pick">
            ...
            <div class="customer-modal__type-grid">
                <button type="button" class="customer-modal__type-btn" data-item-category="jewelry">
                    <span data-lang="ar" data-lang-display="block"><?php echo e($categories['jewelry']['ar']); ?></span>
                    <span data-lang="en" data-lang-display="block"><?php echo e($categories['jewelry']['en']); ?></span>
                ...
                <button type="button" class="customer-modal__type-btn" data-item-category="gemstone">
                    <span data-lang="ar" data-lang-display="block"><?php echo e($categories['gemstone']['ar']); ?></span>
                    <span data-lang="en" data-lang-display="block"><?php echo e($categories['gemstone']['en']); ?></span>
        ...
        <div id="customerStepForm" class="customer-modal__step-form">
            ...
            <form id="customerForm" novalidate enctype="multipart/form-data">
                ...
                <?php echo $__env->make('partials.customer-form-jewelry', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <?php echo $__env->make('partials.customer-form-gemstone', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                ...
                <div class="customer-modal__section">
                    ...
                    <div class="customer-modal__checks" data-purpose-group="jewelry">
                        <?php $__currentLoopData = $jPurposes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $labels): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <label class="customer-modal__check">
                                <input type="checkbox" name="evaluation_purpose[]" value="<?php echo e($key); ?>">
                                <span data-lang="ar" data-lang-display="inline"><?php echo e($labels['ar']); ?></span>
                                <span data-lang="en" data-lang-display="inline"><?php echo e($labels['en']); ?></span>
                            </label>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    <div class="customer-modal__checks" data-purpose-group="gemstone" hidden>
                        <?php $__currentLoopData = $gPurposes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $labels): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <label class="customer-modal__check">
                                <input type="checkbox" name="evaluation_purpose[]" value="<?php echo e($key); ?>">
                                <span data-lang="ar" data-lang-display="inline"><?php echo e($labels['ar']); ?></span>
                                <span data-lang="en" data-lang-display="inline"><?php echo e($labels['en']); ?></span>
                ...
                <div class="customer-modal__section" style="border-bottom:none;">
                    ...
                    <div class="customer-modal__field">
                        ...
                        <select class="customer-modal__input" name="referral_source">
                            <option value="">—</option>
                            <?php $__currentLoopData = $referral; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $labels): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<script src="<?php echo e(asset('js/customer-modal.js')); ?>" defer></script>
<?php /**PATH C:\xampp\htdocs\Sultan-Jewelryy\resources\views/partials/customer-modal.blade.php ENDPATH**/ ?>